...
import com.pms.Connectivity.FetchMyPerformanceShopDetails;
...
public class TabShope  extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab_shope, container, false);
        return v;
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) getView().findViewById(R.id.shopeList);
        recyclerView.setHasFixedSize(true);

        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);

        adapter = new PerFormanceShopeListAdapter(myPerformanceListItem);
...
//            FetchMyPerformanceDetails fetMyPerformanceDetails = new FetchMyPerformanceDetails(TabShope.this);
//            fetMyPerformanceDetails.PerformanceDetails(myPerformanceListItem,recyclerView, adapter, idofUser, progressDialog);

            FetchMyPerformanceShopDetails fetMyPerformanceDetails = new FetchMyPerformanceShopDetails(TabShope.this);
            fetMyPerformanceDetails.PerformanceDetails(myPerformanceListItem,recyclerView, adapter, idofUser, progressDialog);
        } catch (Exception e) {
            e.printStackTrace();
