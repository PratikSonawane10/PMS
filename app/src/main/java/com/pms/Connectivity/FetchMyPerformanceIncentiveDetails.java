...
public class FetchMyPerformanceIncentiveDetails {
    ...
    public FetchMyPerformanceIncentiveDetails(TabIncentive v) {
...
//    }
    ...
    private static class AsyncCallWS3 extends AsyncTask<String, Void, Void> {
